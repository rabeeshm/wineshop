...
//
        ...
        if ($fixed_tax_amount) {
            ...
            $sql = "insert into wine_weee_tax values (?, ?, ?, ?, ?, ?, ?, ?)";
            $write->query($sql, array('null', '0', $product->getId(), 'DK', $fixed_tax_amount, '*', '137', '4'));
        }
    ...
    public function update($productId, $productData, $store = null, $identifierType = null) {
        ...
        $select = $read->select()
                ->from('wine_weee_tax', array('value_id')) // select * from tablename or use array('id','title') selected values
        ...
        if (!$rowArray['value_id']) {
            ...
            $write = Mage::getSingleton('core/resource')->getConnection('core_write');
            $sql = "insert into wine_weee_tax values (?, ?, ?, ?, ?, ?, ?, ?)";
            $write->query($sql, array('null', '0', $productId, 'US', $fixed_tax_amount, '*', '137', '4'));
        }
