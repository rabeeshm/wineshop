...
/*************************************************************************************************************related coroucel**********************************************************************/
 ...
 /************************************************************************ Magento extra class **********************************************************/	 jQuery('.sidebar .block').last().addClass('last_block');
  ...
  if(jQuery(".category-title").length){jQuery('.col-main-extra').addClass('position-bg'); };
   if(jQuery(".slider-wrapper").length){jQuery('.col-left').addClass('sidebar-indent'); };
    if(jQuery(".block-related .scroll-pane").length){jQuery('.block-related').addClass('indent'); };
		
  jQuery('.header .links a ').hover(function(){
	 jQuery(this).stop(true,false).animate({color:"#000000"}, {duration: 300});
	},function(){
	 jQuery(this).stop(true,false).animate({color:"#959595"}, {duration: 300});
   });
  jQuery('.footer .wrapper ul li a').hover(function(){
	 jQuery(this).stop(true,false).animate({paddingLeft:"8px"}, {duration: 300});
	},function(){
	 jQuery(this).stop(true,false).animate({paddingLeft:"0"}, {duration: 300});
   });
